					...
					<ul class="app_list">
                        <li class="clear">
                            ...
                            <div class="app_content email_area">
                                ...
                                <input type="text" name="tripdate" value="${vo.tripdate }" id="datepicker_a" required="required" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" >
                            </div>
						</li>
						...
						<li class="clear">
                            ...
                            <div class="app_content email_area">
                            <!-- 화면에서는 tno가 필요하지만 보이지는 않아야 하기 때문에 hidden태그 이용해서 넘겨주기! -->
						...
						<li class="clear">
							...
							<div class="app_content">
								<input type="text" name="title" value="${vo.title }" class="w100p" id="name_lbl"  required="required"/>
							</div>
						</li>
